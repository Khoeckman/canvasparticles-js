  ...
  Prism = (function (l) {
      ...
      j = {
        ...
        highlight: function (e, t, n) {
          ...
          if ((j.hooks.run('before-tokenize', e), e.grammar))
            return (
              (e.tokens = j.tokenize(e.code, e.grammar)), j.hooks.run('after-tokenize', e), C.stringify(j.util.encode(e.tokens), e.language)
            )
                        ...
                        for (
                          var g,
                            ...
                            f =
                              (m &&
                                !c.pattern.global &&
                                ((g = c.pattern.toString().match(/[imsuy]*$/)[0]), (c.pattern = RegExp(c.pattern.source, g + 'g'))),
                              c.pattern || c),
                            b = r.next,
                            y = s;
    ...
    if (
      ...
      (C.stringify = function t(e, n) {
        ...
        var r,
          s = { type: e.type, content: t(e.content, n), tag: 'span', classes: ['token', e.type], attributes: {}, language: n },
          e = e.alias,
  ...
  (function () {
    ...
    void 0 !== Prism &&
      ...
      (Prism.fileHighlight = function () {
        e || (console.warn('Prism.fileHighlight is deprecated. Use `Prism.plugins.fileHighlight.highlight` instead.'), (e = !0)),
